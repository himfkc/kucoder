  ...
  <div class="top-right-btn" :style="style">
    <el-row>
      <el-tooltip class="item" effect="dark" :content="showSearch ? '隐藏搜索' : '显示搜索'" placement="top" v-if="search">
        <el-button size="small" type="info" plain circle @click="toggleSearch()">
          <icon-ep-search class="w-4" />
        </el-button>
      </el-tooltip>
      <el-tooltip class="item" effect="dark" content="刷新" placement="top">
        <el-button size="small" type="info" plain circle @click="refresh()">
          <icon-ep-refresh class="w-4" />
        </el-button>
      </el-tooltip>
      <el-tooltip class="item" effect="dark" content="显隐列" placement="top" v-if="columns">
        <el-button size="small" type="info" plain circle @click="showColumn()" v-if="showColumnsType == 'transfer'">
          <icon-ep-menu class="w-4" />
        </el-button>
