...
class PluginLocalController extends AdminBase
{
    ...
    public function install(): Response
    {
        ...
        try {
            ...
            $pluginLocal->save();
            dump(KcConst::KC_COMMAND . '安装完成，请重启后端webman');
            return $this->success('请重启后端webman');
        } catch (Throwable $t) {
            dump(KcConst::KC_COMMAND . '安装未完成: ', $this->errorInfo($t));
    ...
    public function uninstall(): Response
    {
        ...
        try {
            ...
            dump(KcConst::KC_COMMAND . '卸载完成');
            return $this->success('请重启后端webman');
        } catch (Throwable $t) {
            dump(KcConst::KC_COMMAND . '卸载未完成: ', $this->errorInfo($t));
    ...
    public function update(): Response
    {
        ...
        try {
            ...
            $pluginLocal->save();
            dump(KcConst::KC_COMMAND . '升级完成');
            return $this->success('请重启后端webman');
        } catch (Throwable $t) {
            dump(KcConst::KC_COMMAND . '升级未完成: ', $this->errorInfo($t));
