<template>
  <div class="login">
    <el-form ref="loginRef" :model="loginForm" :rules="loginRules" class="login-form">
      <div class="title x c ac gap-2">
        <img v-show="showLogo" :src="logo" class="w-5" />系统后台
      </div>
    ...
    <!-- <div class="el-login-footer">
      <span>Copyright © 2026-2099 kucoder All Rights Reserved.</span>
    </div> -->
  </div>
</template>
...
const logo = import.meta.env.VITE_DEPLOY_DIR + '/logo.png'
const codeUrl = ref("");
